...
export default function ShortcutHelp({ isOpen, onClose }: ShortcutHelpProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-[#22252b] border border-white/10 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
        ...
        <div className="p-4 border-b border-white/10">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-[#1a1c20] border border-white/10 rounded-lg text-white text-sm placeholder-gray-600 outline-none focus:border-teal-500/50"
              autoFocus
            />
          </div>
        </div>
                  ...
                  <div key={i}
                    ...
                    <div className="flex items-center gap-1">
                      {shortcut.keys.map((key, j) => (
                        <span key={j}>
                          <kbd className="px-2 py-0.5 bg-[#1a1c20] border border-white/20 rounded text-[10px] text-gray-400 font-mono">
                            {key}
                          </kbd>
        ...
        <div className="px-6 py-3 border-t border-white/10 bg-[#16181c]/50 text-center">
